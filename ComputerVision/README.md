...
The ComputerVision project is divided into three tasks.
...
The second task is equal to the first execpt that instead of audio signals we have used images. So the model recognizes a group member by a picture.  
