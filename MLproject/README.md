...
The Cardiotocography dataset, available [here](https://archive.ics.uci.edu/ml/datasets/cardiotocography#), contains 23 attributes.  
We have built three classifier using Knime in order to solve three different tasks (binary, 3-class and 10-class classification). 
